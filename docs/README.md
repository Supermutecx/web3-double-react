...
The documentation that follows is for `@web3-double-react/core`, the package responsible for managing this context. To understand where the data itself comes from, head over to the [connectors/ folder](./connectors/).
...
- ...and then install `web3-react`\
  `yarn add @web3-double-react/core`
...
#### Example
```javascript
import { Web3ReactProvider } from '@web3-double-react/core'
...
#### Example
```javascript
import { useWeb3React } from '@web3-double-react/core'
...
#### Example
```javascript
import { Web3ReactProvider, createWeb3ReactRoot } from '@web3-double-react/core'
// import your favorite web3 convenience library here
...
#### Example
```javascript
import { getWeb3ReactContext } from '@web3-double-react/core'
...
#### Example
```javascript
import { UnsupportedChainIdError } from '@web3-double-react/core'
// ...
